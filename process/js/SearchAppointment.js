                ...
                <div className="col-sm-offset-3 col-sm-6">
                    ...
                    <div className="input-group-btn">
                        ...
                        <ul className="dropdown-menu dropdown-menu-right">
                            ...
                            <li><a href="#" id="asc" onClick={ this.handleOrder }>Asc { (this.props.orderBy === 'asc') ? <span className = "glyphicon glyphicon-ok"></span>: null}</a></li>
                            <li><a href="#" id="desc" onClick={ this.handleOrder }>Desc { (this.props.orderBy === 'desc') ? <span className = "glyphicon glyphicon-ok"></span>: null}</a></li>
                        </ul>
                    </div>
                    </div>
                </div>
